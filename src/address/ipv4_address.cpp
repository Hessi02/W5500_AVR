...
bool
IPv4Address::validateAddressString (const char *addressAsString) const
{
    uint8_t iterator = 0;
...
void
IPv4Address::parseAddressString (const char *addressString)
{
    uint8_t iterator = 0;
...
const unsigned char *
IPv4Address::toArray (void) const
{
    return _bytes;
}
