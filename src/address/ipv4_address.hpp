...
public:
     ...
     *  Please note: The format of the address is as follows: "XYZ.XYZ.XYZ.XYZ" 
     */
...
private:
     ...
     *  Currently only the number of periods is counted. It would also be obvious 
     ...
     *  entries. In addition, the use of hexadecimal numbers is currently not 
     ...
     * 
     *  It represents the main storage of the IPv4 address. The methods based on it 
     *  are merely tools for assignment, modification and use.
     */
 ...
 * 
 *  Even if the format of the subnet mask and the IPv4 address are the same, they are 
 *  different objects and must be treated as such. This is achieved by using a typedef.
 */
