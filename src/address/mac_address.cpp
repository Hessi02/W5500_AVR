...
bool
MACAddress::validateAddressString (const char *addressAsString) const
{
    uint8_t iterator = 0;
...
void
MACAddress::parseToTwoDim (const char *addressString, char addressInTwoDim[6][2]) const
{
...
void
MACAddress::convertCharToInt (const char addressInTwoDim[6][2])
{
    for (uint8_t i = 0; i < 6; i++)
        {
