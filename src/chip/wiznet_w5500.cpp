...
uint8_t
W5500::registerSocket (AbstractSocket *socket)
{
...
void
W5500::unsubscribeSocket (const uint8_t &index)
{
    _occupiedSocketMask &= ~(1 << index);
}

void
W5500::resetRegister (const uint16_t &registerAddress) const
{
