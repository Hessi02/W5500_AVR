...
AbstractSocket::AbstractSocket (
    W5500 *chipInterface,
    const uint16_t &port) : _chipInterface (chipInterface)
{
...
uint8_t
AbstractSocket::getIndex (void) const
{
    return _index;
}

void
AbstractSocket::setLocalPort (const uint16_t &port)
{
...
void
AbstractSocket::writeControlRegister (
...
void
AbstractSocket::readControlRegister (
    const uint16_t &addressWord,
...
void
AbstractSocket::sendBuffer (void)
{
...
void
AbstractSocket::send (const char *data)
{
    uint16_t iterator = 0;
...
void
AbstractSocket::writeBufferRegister (const uint16_t &addressRegister, const unsigned char *data, const uint8_t &length)
{
...
uint16_t
AbstractSocket::getTXWritePointer (void)
{
...
void
AbstractSocket::setTXWritePointer (const uint16_t &length)
{
...
void
AbstractSocket::setTXReadPointer (const uint16_t &length)
{
    const unsigned char lengthArray[2] = {
        static_cast<unsigned char> ((length >> 8) & 0xff),
        static_cast<unsigned char> (length & 0xff)
